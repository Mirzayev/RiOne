...
export default function MediumTariff() {
    ...
    return (
        <div className="  flex flex-col items-center">
            ...
            <div className="flex w-full   items-center  mt-6  mb-[40px]">
               <div className={"flex  justify-start"}> <NavLink to="/"> <i className="fa-solid fa-arrow-left"></i> </NavLink></div>
                <div className={"flex w-full justify-center"}><p className={" text-center  font-medium text-[16px]"}>Medium tarif</p></div>
            </div>
