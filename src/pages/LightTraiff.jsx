...
export default function LightTraiff() {
        ...
        <div className="lightTraiff  flex flex-col items-center">
            ...
            <div className="flex w-full   items-center  mt-6  mb-[40px]">
                ...
                <div className={"flex w-full justify-center"}><p
                    className={" text-center  font-medium text-[16px]"}>Light tarif</p></div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 mt-6 w-full max-w-md">
                {tariffs.map((tariff) => (
                    ...
                    >
                        ...
                        {tariff.benefit &&
                            <p className="text-white bg-yellow-500   py-1 rounded-lg text-[12px] w-2/3 px-2">{tariff.benefit}</p>}
